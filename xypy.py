...
pg.draw.line(ccs,BLACK,(1.5*cell_w,0),(1.5*cell_w,h),18)
...
"""Draw products in corners for later"""
# font = pg.font.SysFont('miriam', 20)
# px = 0
# for x in range(cell_w//2,w,cell_w):
#     px += 1
#     py = 0
#     for y in range(cell_w//2,h,cell_w):
#         py += 1
#         if py > 1 and py < 11 and px > 1 and px < 11:
